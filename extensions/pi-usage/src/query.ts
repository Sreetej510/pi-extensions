...
import {
	STATUSLINE_RETRY_ATTEMPTS,
	STATUSLINE_RETRY_DELAY_MS,
} from "./constants.js";
import { isStaleExtensionContextError, isRateLimitErrorMessage } from "./errors.js";
import {
...
export async function queryAllUsage(
	...
	const [codexSettled, anthropicSettled] = await Promise.allSettled([
		hasCodex
			? queryCodexUsageWithFallback(ctx, options.timeoutMs)
