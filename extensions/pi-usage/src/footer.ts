...
function renderUsageFooter(
  ...
  const contextPercent = contextUsage && contextUsage.percent !== null ? contextPercentValue.toFixed(1) : "?";
...
function renderUsageStatusLine(theme: FooterTheme, footerData: FooterDataView, width: number): string | undefined {
