...
import type { CodexUsageReport, RateLimitStatusPayload, UsageQueryError, UsageReport } from "./types.js";
import { errorMessage, parseJsonObject } from "./utils.js";

export async function queryViaPiAuth(ctx: ExtensionContext, timeoutMs: number): Promise<CodexUsageReport> {
