...
export function createGapFinderTool(capture: { gaps?: TestGapCandidate[] }): ToolDefinition<typeof gapFinderToolParams> {
	return {
...
export function createGapValidatorTool(capture: { gaps?: TestGapFinal[] }): ToolDefinition<typeof gapValidatorToolParams> {
	return {
